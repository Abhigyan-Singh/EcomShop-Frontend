  ...
  return (
    <div className="border-l border-yellow-200 me-2">
      <button
        ...
        onClick={toggleShow}
      >
        <span className="mr-12" style={{ color: 'black' }}>
          Total
        </span>
      ...
      <Offcanvas
        className="max-w-sm w-full h-full bg-white shadow flex flex-col md:max-w-xs"
        backdrop={true}
        placement="end"
        show={show}
        onHide={handleClose}
      ...
      >
        <Offcanvas.Header
          className="border-b flex items-start justify-between p-4"
          closeButton
        >
          <Offcanvas.Title>
        ...
        <Offcanvas.Body onHide={handleClose}>
          <div
            className="relative flex-1 text-lg font-medium cbn-cart cbn-cart__item "
            style={{ textDecorationLine: 'underline', textDec }}
          >
