        ...
        <div class="containerSingleColumn">
            <div>
                ...
                <div id="store-preference" class="preference-container default-content-size active-block" >
                    <div class="f-sign-up__form col-md-10 clearfix float-disable">
                        <div id="store-preference__store-window">
                            ...
                            <div class="f-sign-up__form-bottom col-md-12">
                                ...
                                <div id="deliveryInstructionsBlock">
                                    <div id="q-preference__preference" class="col-md-9 store-container row _padding-0-10 _padding-left-30 _margin-bottom-25 _pos-relative store-preference-required"><div class="store-container f-sign-up__radio-group" style={{display: 'block',width: '100%'}}>
                                        Congratulations! Your address is eligible for delivery from the following store(s):
                                        <div class="delivery-stores padtop padleft" style={{width: '100%'}}><div class="row"></div>
                                            ...
                                            <label style={{fontWeight: 'bold', fontStyle: 'italic',whiteSpace: 'nowrap', }}> - Delivered by  DoorDash*</label>
                                        </div><div style={{fontSize: '18px', fontWeight: 'bold', fontStyle: 'italic', float: 'left', padding: '20px', color: 'blue'}}>*Delivery fee is $8.99 for the first 3 miles from the store to your delivery address and $.65 for each additional mile. All grocery orders must be over $50 to avoid additional charges.</div>
                                        ...
                                        <div class="padtop"><label for="DeliveryInstructions"><b>DELIVERY INSTRUCTIONS</b> (optional)</label><textarea id="deliveryInstructions" name="deliveryInstructions" rows="8" cols="60" maxlength="255"></textarea>
                                        </div></div></div>
                                </div>
                            </div>
                            <div class="f-sign-up__form-bottom col-md-6">
