      ...
      <div>
        <div>
          <div class="default-content-size">
            <b>
              <a href="/myAccount">My Account Home</a> &gt; Delivery Eligibility
            </b>
          </div>
          ...
          <div
            id="store-preference"
            class="preference-container default-content-size active-block"
          >
              ...
              <div id="store-preference__store-window">
                <div class="f-sign-up__form-top _margin-bottom-10 col-md-12">
                  <div class="store-preference f-sign-up__error-box">
                    ...
                    <span class="f-sign-up__error-msg _required right-store-preference__preference preference f-sign-up__error-box-title"></span>
                  </div>
                </div>
                ...
                <div class="f-sign-up__form-bottom col-md-12">
                  <div id="deliveryInstructionsBlock">
                    <div
                      id="q-preference__preference"
                      class="col-md-12 store-container adjstPad row _padding-0-10 _padding-left-30 _margin-bottom-25 _pos-relative store-preference-required"
                    >
                      <div
                        class="store-container"
                        style={{ display: 'block', width: '100%' }}
                      >
                        Congratulations! Your address is eligible for delivery
                        from the following store(s):
                        <div
                          class="delivery-stores padtop padleft"
                          style={{ width: '100%' }}
                        >
                          <div class="dstoreRow">
                            <input
                              class="f-sign-up__radio"
                              name="deliveryOrPickupStore"
                              type="radio"
                              required="required"
                              style={{ width: '100%' }}
                              id="delivery-605"
                            ...
                            />
                            <label
                              class="f-sign-up__radio-label col-md-3"
                              for="delivery-605"
                            >
                              Albertville, MN
                            </label>
                        ...
                        >
                          *Delivery fee is $8.99 for the first 3 miles from the
                          store to your delivery address and $.65 for each
                          additional mile. All grocery orders must be over $50
                          to avoid additional charges.
                        </div>
                        <div class="padtop">
                          <p>
                            Select the location above from which you'd prefer to
                            receive your delivery.Please include special
                            delivery instructions below — which door to bring
                            your groceries to,whether or not to ring the bell,
                            etc. — the more specific the better! 255 character
                            limit.
                          </p>
                        </div>
                        <div class="dlInsSec">
                          <label for="DeliveryInstructions">
                            <b>DELIVERY INSTRUCTIONS</b> (optional)
                          </label>
                          <textarea
                            className="textbackgroundcolor"
                ...
                <div class="f-sign-up__form-bottom">
                  <div class="row dpo-buttons-block mt-5">
                    <div class="col-6">
                      <button
                        id="savePreferredStoreChanges"
                        type="button"
                        class="f-sign-up__btn _full-width"
                      >
                        OK
                      </button>
                    </div>
          ...
          <div
            id="deliveryNotAvailable"
            class="padleft"
            style={{ display: 'none', width: '40%', fontSize: '14px' }}
          >
            <div class="padtop">
              Delivery is not currently available for the account address you
              entered. Please check back periodically as we continue to expand
