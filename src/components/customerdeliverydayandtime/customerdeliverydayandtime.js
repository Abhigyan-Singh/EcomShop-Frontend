    ...
    <div className="wrapper">
      <div className="containerSingleColumn">
        <div>
          ...
          <b>
            <a href="/myAccount">My Account Home</a> &gt; Delivery day &amp;
            time
          </b>
          <br />
          <br />
          ...
          <form
            action="editcustomerdeliverydayandtime"
            name="editcustomerdeliverydayandtime"
          >
            <p>
              Please choose your new regular delivery day from the choices
              below.
              <b>Remember to click the "Save changes" button.</b>
              <br />
              <br />
              We'll confirm your change via e-mail. If you have questions,
              please call <nobr />1 (844) 414-7467
              <nobr />.
            </p>
            ...
            <div className="Element-100">
              ...
              By selecting a delivery time below, I understand that some
              information will be shared with DoorDash in connection with my
              delivery order: name, address, telephone number.
            </div>
            <br />
            {/* <div className="Element-100">
...
/                                                        &nbsp;
 ...
 /                                                       &nbsp;
            ...
            <a href="javascript:popUp('/wsPolicy',910, 520, '1', '0')">
              Wine &amp; Spirits delivery policy
            </a>
