  ...
  const saveChange = () => {
    ...
    if (!!oldPassword && !password && !confirmPassword) {
      ...
      if (password !== confirmPassword) {
        ...
        axios
          .put(
            `http://localhost:8009/user/change-password/${cookies.userName}`,
            Body,
            { headers }
          )
          .then((res) => {
  ...
  return (
    <div className="pad">
      <div className="header-gray">
        ...
        <a href="/myaccountinformation">Account &amp; Password</a> &gt; Change
        Password
      </div>

      <div className="myAccountSubHeader margin-20px-btm">Change Password</div>
      <div>
        Please make any necessary changes to the information below. Press "Save
      ...
      <div className="account-info-box margin-10">
        ...
        <form method="post" action="changepassword" id="changepassword">
          <div className="forgot-row pad">
            ...
            <div>
              <label for="oldPassword" style={{ fontWeight: 'normal' }}>
                <span className="copy-red">*</span> OLD Password
              </label>
              <input
                type="password"
          ...
          <div className="forgot-row pad">
            ...
            <p class="mar-tb-10">
              Required fields are marked with an asterisk{' '}
              <span className="copy-red">*</span>. Password must be between 8
              and 16 characters long.
            </p>

            <div className="margin-20px-btm">
              <label for="newPassword" style={{ fontWeight: 'normal' }}>
                <span className="copy-red">*</span> NEW Password
              </label>
              <input
                type="password"
                className="f-sign-up__field required-field"
            ...
            <div>
              <label for="reEnterPassword" style={{ fontWeight: 'normal' }}>
                <span className="copy-red">*</span> Re-enter NEW Password
              </label>
              <input
                type="password"
                className="f-sign-up__field required-field"
          ...
          <div className="forgot-row pad">
            <div className="header">
              Be sure to record your Username and Password and keep them in a
              safe place.
            </div>
            (But not to worry, if you do happen to lose them, we can help you
            out.)
          </div>
        </form>
      </div>
      <div className="button-box-sec margin-10">
        <input
          ...
          value="CANCEL"
          alt="Cancel"
          className="btn-responsive f-sign-up__btn left"
          onClick={() => navigate('/myaccountinformation')}
        />
        <input
          type="button"
          value="SAVE CHANGES"
