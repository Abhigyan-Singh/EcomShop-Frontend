...
export default function DeliveryNotesInstructions() {
  ...
  return (
    <div className="wrapper">
      ...
      <b>
        <a href="/myAccount">My Account Home</a> &gt; Delivery notes &amp;
        instructions{' '}
      </b>
      <br />
      <br />
      <br />
      <span className="headerbig-green">
      ...
      <label for="altDeliveryInstructions">
        <b>
          In general, will someone be home to receive your grocery delivery?
        </b>
      </label>
      <br />
      <form name="delivery_info" action="updatedeliveryinfo.action">
        <select
          id="altDeliveryInstructions"
          name="altDeliveryInstructions"
          className="dlvInstSlct"
        >
        ...
        <label for="DeliveryInstructions">
          ...
          <br />
          Please enter delivery instructions for your Neighborhood Service
          Representative.
          <br />
      ...
      <input
        ...
        onclick="document.delivery_info.submit()"
      />
      &nbsp;&nbsp;
      <input
        type="button"
