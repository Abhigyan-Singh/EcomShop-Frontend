...
export default function MyAccount() {
    return (
        <div className="wrapper">
            ...
            <div>
                <h1 class="myAccountHeader">My Account</h1>
                <p>
                ...
                <div className='arrow'>
                    ...
                    <a class="header-green" href="/myaccountinformation"> Account & Password</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/">  Change Preferred Store</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/"> Delivery Preferences</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/">Communication Preferences</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/"> Product Display Preferences</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/"> Order History</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/checkoutPayment"> Payment Information</a>
                </div>
                <div className='arrow'>
                    <img alt="Account and Password preferences" src={my_account_arrow_right} />
                    <a class="header-green" href="/">MORE rewards</a>
                </div>
                {/* <div className='arrow'>
                <img alt="Account and Password preferences" src={my_account_arrow_right}/>
                <a class="header-green" href="/">  Change Preferred Store</a>
